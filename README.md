...
**7만 명 이상의 스트리머**가 이미 VZZK과 함께 방송하고 있습니다.
...
투표는 A 사이트, 음악 신청은 B 사이트, TTS는 C 프로그램...

**VZZK 하나면 전부 됩니다.**

- 탭 10개 띄워놓고 왔다 갔다 할 필요 없음
- 사이트마다 다른 설정 방식 익힐 필요 없음
- 한 화면에서 모든 기능을 켜고 끄고 설정

### 🔒 내 데이터는 내 PC에만

VZZK은 모든 데이터를 로컬에 저장합니다.

- 후원 금액, 시청자 정보 등 민감한 데이터가 외부 서버로 전송되지 않음
- 계정 정보는 내 컴퓨터에만 암호화되어 저장
- 서비스 종료 걱정 없이 내 설정 그대로 유지
...
| 기능                                                                                                                                                                                                                                   | 설명                           |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ |
| [노래 신청 봇](https://github.com/auejin/vzzk-bot/wiki/SR%EB%B4%87-%E2%80%90-%EB%B0%A9%EC%86%A1-%EC%9D%8C%EC%95%85-%EC%B6%94%EC%B2%9C-%ED%94%8C%EB%9F%AC%EA%B7%B8%EC%9D%B8)                                                            | 시청자가 직접 음악 신청        |
| [채팅 읽기 봇](https://github.com/auejin/vzzk-bot/wiki/%EC%B1%84%ED%8C%85-%EC%9D%BD%EA%B8%B0-%EB%B4%87-%E2%80%90-%EC%B9%98%EC%A7%80%EC%A7%81-%EC%B1%84%ED%8C%85%EC%9D%84-%EC%9D%BD%EC%96%B4%EC%A3%BC%EB%8A%94-TTS-%EB%B4%87)           | 밈까지 자연스럽게 읽어주는 TTS |
...
- [**윈도우** VZZK 다운로드](https://storage.googleapis.com/vzzk/release/Vzzk_Windows.msi)
...
- [**리눅스** VZZK 다운로드](https://storage.googleapis.com/vzzk/release/Vzzk_Ubuntu.AppImage)
