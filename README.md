...
![Downloads](https://img.shields.io/badge/downloads-47K+-blue)
...
VZZK은 치지직 스트리머를 위한 **무료 채팅봇이자 올인원 방송 도구**입니다.
방송에 꼭 필요한 기능들을 VZZK 프로그램 하나로 간편하게 관리해 보세요.
...
* **커스텀 [방송 오버레이](https://github.com/auejin/vzzk-bot/wiki/%EB%B0%A9%EC%86%A1-%EC%98%A4%EB%B2%84%EB%A0%88%EC%9D%B4)**
    * 투표, 룰렛, 추첨 등 모든 과정을 OBS 화면에 바로 띄워 "내 방송만의 특별한 컨텐츠"를 만들 수 있습니다.

## 다운로드

프로그램은 아래의 링크를 통해 다운로드 하실 수 있어요!
보안 프로그램이 실행을 막는 경우, [본 위키 페이지](https://github.com/auejin/vzzk-bot/wiki#%EB%B3%B4%EC%95%88-%EC%9D%B4%EC%8A%88-%ED%95%B4%EA%B2%B0%ED%95%98%EA%B8%B0)를 따라하시면 간단히 해결할 수 있습니다.
...
> **VZZK을 처음 사용하시나요?**
>
> [**'VZZK 첫 사용 방법'**](https://github.com/auejin/vzzk-bot/wiki/VZZK-%EC%B2%AB-%EC%82%AC%EC%9A%A9-%EB%B0%A9%EB%B2%95) 페이지에서 스크린샷과 함께 쉽게 시작하세요!

### 최초 실행 시 로그인 방법

1.  왼쪽 VZZK 탭에서 '연결하기'를 누릅니다.
2.  오른쪽 상단에 있는 회색 토글 (모두 연결하기) 버튼을 누릅니다.
3.  '치지직 로그인 실패' 팝업이 뜬다면, '확인' 버튼을 누릅니다.
4.  자동으로 열린 브라우저에서 네이버 계정으로 로그인합니다.
5.  '치지직 로그인 성공' 팝업이 뜬다면 '확인' 버튼을 누릅니다.
6.  다시 VZZK 탭의 회색 토글 (모두 연결하기) 버튼을 누르면 연결 성공!

## 버그 제보 & VZZK 사용자 커뮤니티

버그를 발견하셨거나, "이런 기능도 있으면 좋겠어요!" 하는 아이디어가 있다면?

아래 [디스코드](https://discord.gg/nej5zmZADX)로 들어오시면 개발자 및 다른 스트리머분들과 직접 얘기할 수 있어요!
